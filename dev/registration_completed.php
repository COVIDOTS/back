  ...
  <section class="mainblock3">
    <div class="row col-8 reg" style="border: 1px solid white;">
        <div style="margin-top: 30px; display: flex; flex-direction: column;justify-content: center;">
            <a style="font-size: 28px !important">Thank you for joining us!</a>
            <a style=" font-size: 22px !important">Log in to your personal account</a>
            <button type="submit" class="btn btn-primary"> <a style="font-size: 18px !important ; color: #ffffff" type="button" href="login.php">Login</a></button><br>
        </div>
    </div>
  </section>
  </body>
